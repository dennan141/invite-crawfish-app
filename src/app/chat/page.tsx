    ...
    return (
        <div className="min-h-screen p-6">
            ...
            <main className="max-w-3xl mx-auto mt-8 space-y-4">
                ...
                {!user &&
                    <p className="text-sm text-red-600">No user selected. Messages will appear as &quot;Anon&quot;. Go
                        to Select User to set your name.</p>}

                <div className="rounded-xl border p-4 h-[50vh] overflow-y-auto bg-black/5 dark:bg-white/5">
                    {messages.length === 0 && (
                        <p className="text-sm opacity-70">Jag håller på att skapa den chilla fan</p>
                    )}
